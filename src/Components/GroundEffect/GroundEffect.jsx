...
const GroundEffect = () => {
  ...
  const extractDataFromCSV = async () => {
    ...
    try {
      ...
      const Player_Country_Afghanistan =
        extractedRow[3] === "Afghanistan" ? 1 : 0;
      const Player_Country_Australia = extractedRow[3] === "Australia" ? 1 : 0;
      const Player_Country_Bangladesh =
        extractedRow[3] === "Bangladesh" ? 1 : 0;
      const Player_Country_England = extractedRow[3] === "England" ? 1 : 0;
      const Player_Country_India = extractedRow[3] === "India" ? 1 : 0;
      const Player_Country_New_Zealand =
        extractedRow[3] === "New_Zealand" ? 1 : 0;
      const Player_Country_Pakistan = extractedRow[3] === "Pakistan" ? 1 : 0;
      const Player_Country_South_Africa =
        extractedRow[3] === "South_Africa" ? 1 : 0;
      const Player_Country_Sri_Lanka = extractedRow[3] === "Sri_Lanka" ? 1 : 0;
      const Player_Country_West_Indies =
        extractedRow[3] === "West_Indies" ? 1 : 0;
  ...
  return (
    <div className="ground-effect-grid">
      <div className="ground-effect-div1">
        <div className="card-ground-effect">
          <div className="column-ground-effect ">
            <h3 className="card-title">
              Runs Predictor - Team-Ground Dynamics
            </h3>
            <br />
            <label htmlFor="groundName" className="card-subtitle">
              Ground Name:
            </label>
            ...
            <br />
            <label htmlFor="playerCountry" className="card-subtitle">
              Player Country:
            </label>
            <select
              value={playerCountry}
            ...
            <br />
            <label htmlFor="oppositionCountry" className="card-subtitle">
              Opposition Country:
            </label>
            <select
              value={opponentTeam}
            ...
            <label htmlFor="playerName" className="card-subtitle">
              Player Name:
            </label>
            <input
              type="text"
